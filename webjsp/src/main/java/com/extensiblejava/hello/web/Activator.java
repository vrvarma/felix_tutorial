	...
	public void start(BundleContext bc) throws Exception {
		...
		if (m_httpServiceRef != null) {
			...
			if (webContainer != null) {
				...
				webContainer.registerServlet("/", new HelloWorldServlet(),
						initParams, httpContext);
				// register JSP
				webContainer.registerJsps(new String[] { "/webjsp/jsp/*" },
						httpContext);
				// register html pages as resources
				webContainer.registerResources("/webjsp/html", "/", httpContext);
			}
		}
	}
